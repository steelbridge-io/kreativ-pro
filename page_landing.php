 ...
 * Kreativ Pro.
 *
 * This file adds the landing page template to the Kreativ Pro Theme.
 *
...
add_filter( 'body_class', 'kreativ_landing_body_class' );
function kreativ_landing_body_class( $classes ) {
