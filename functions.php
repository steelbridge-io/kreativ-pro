...
function kreativ_scripts_styles() {
	...
	if(is_front_page() ) {
	  wp_enqueue_script('bootstrap-js', get_stylesheet_directory_uri() . '/assests/js/bootstrap.bundle.min.js', array
    (), '4', true );
	  wp_enqueue_script('bootstrapjs', get_stylesheet_directory_uri() . '/assets/js/bootstrap.min.js', array(), '4',
      true );
